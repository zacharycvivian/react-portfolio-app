    ...
    <div className={styles.layoutContainer}> 
      ...
      <div className="container flex justify-center align-middle">
        <div className={styles.homeContainer}>
          <h1 className={styles.welcomeMessage}>Hello, {session?.user?.name || 'Guest'}</h1>
          <p className={styles.instructions}>Click the icon on the top left to learn more about me!</p>
          <div className={styles.infoContainer}>
            <h2>Welcome to my Resume Website!</h2>
            <p>My name is Zachary Vivian, I'm graduating the University of Wisconsin - Platteville in May 2024 with a degree in Cybersecurity. On this website, you can find out more about myself and leave a testimonial if you'd like to help my career development and have been happy with my work in the past.</p>
          </div>
