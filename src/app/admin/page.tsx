...
async function toggleVerification(formData: FormData) {
  ...
  const adminDoc = await adminDb.collection("users").doc(requester).get();
    ...
    <div className={styles.container}>
      <div className={styles.tableCard}>
        <div className={styles.cardHeader}>
          ...
          <p className={styles.subtitle}>Signed in as {requester}</p>
        </div>
            ...
            <tbody>
              {feedbackEntries.map((f) => (
                <tr key={f.id}>
                  ...
                  <td align="right" className={styles.timeCell}>
                    {formatTime(f.time)}
                  </td>
