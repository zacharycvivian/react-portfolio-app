...
import Meta from "@/app/about/metadata";
...
const AboutPage = () => {
  ...
  return (
    <>
      <Meta
        title="About - Zach Vivian's Personal Website"
        description="Learn more about Zach Vivian and his skills!"
      />
      <div className={styles.container}>
        ...
        <div className={styles.section}>
          ...
          >
            {" "}
            <p>
              Set to graduate from the University of Wisconsin-Platteville in
              May 2024, with a Bachelor's degree in Cybersecurity accompanied by
              a minor in Business Administration. My academic journey has fueled
              a passion for specializing in either penetration testing or
              incident response, with the goal of safeguarding your organization
              against sophisticated cyber threats and vulnerabilities. As a
              diligent and quick learner, I am keen on employing advanced
              analytical tools to thoroughly evaluate potential security
              breaches. Beyond technical defenses, my proficiency in applying
              cybersecurity frameworks and conducting comprehensive risk
              assessments enables me to develop strategic approaches to bolster
              your cybersecurity posture. My ambition is to contribute to your
              team by not only preempting and mitigating cyber attacks through
              robust security protocols but also ensuring a resilient and
          ...
          >
            ...
            <p>
              ...
              cumulative knowledge of the software development lifecycle,
              ...
              virtual machines for Windows and Linux, utilizing Proxmox VE. This
              allows professors to effortlessly assign and auto-grade lab
              ...
              educational toolkit for future academic use.
            </p>
          </motion.div>
          <motion.div
            className={styles.card}
          ...
          >
            ...
            <p>
              ...
              my friends and my dog, Turbo, by my side. Beyond these adventures,
              I have a keen interest in photography and longboarding, which
              allows me to appreciate the world's beauty from different
              perspectives. Additionally, I dedicate time to personal projects,
              like developing this website, which not only fuels my creativity
              but also sharpens my technical skills.
            </p>
          </motion.div>
          <motion.div
            className={styles.card}
        ...
        <div className={styles.section}>
          ...
          >
            ...
            <p>
              ...
              underscores my commitment to analyzing threats and identifying
              potential vulnerabilities. This proactive approach is aimed at
              fortifying defenses against future cyber attacks, demonstrating my
              dedication to contributing meaningfully to the field.
            </p>
          </motion.div>
          <motion.div
            className={styles.card}
          ...
          >
            ...
            <p>
              ...
              freight trucks, loading customer vehicles, and building equipment
              and floor models. Also worked in the Automotive Service Center as
              an advisor to set up vehicle appointments and order tires.
            </p>
          </motion.div>
          <motion.div
            className={styles.card}
